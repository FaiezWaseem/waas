...
router.post('/', async (req,res)=>{
  try{
    ...
    await db.pool.query('REPLACE INTO agents_meta(agent_id,system_prompt,model,excluded_numbers) VALUES($1,$2,$3,$4)',[id,system_prompt||null,model||'gpt-3.5-turbo',excluded_numbers||null])
